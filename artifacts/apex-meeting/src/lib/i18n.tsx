...
const translations: Translations = {
  ...
  'nav.installAppHint': { pt: 'No menu do browser, toque em "Adicionar à tela inicial" para instalar o app.', en: 'In your browser menu, tap "Add to Home Screen" to install the app.', es: 'En el menú del navegador, toca "Agregar a pantalla de inicio" para instalar la app.' },
  ...
  'landing.p1.f1': { pt: '1 participante remoto',     en: '1 remote participant',    es: '1 participante remoto' },
  ...
  'landing.p2.f1': { pt: '10 participantes remotos',   en: '10 remote participants',  es: '10 participantes remotos' },
  ...
  'landing.p3.f1': { pt: 'Participantes ilimitados',   en: 'Unlimited participants',  es: 'Participantes ilimitados' },
