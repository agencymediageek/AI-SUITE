...
const translations: Record<Locale, Record<string, string>> = {
  pt: {
    ...
    // Dashboard
    "dash.title": "Painel",
    "dash.welcome": "Bem-vindo de volta. Veja o que está acontecendo no seu espaço hoje.",
    "dash.token_balance": "Saldo de Tokens",
    "dash.tokens_used": "Tokens Usados",
    "dash.total_generations": "Total de Gerações",
    "dash.favorites": "Favoritos",
    "dash.billing_cycle": "Neste ciclo de faturamento",
    "dash.usage_overview": "Visão Geral de Uso",
    "dash.usage_desc": "Sua atividade de geração nos últimos 30 dias",
    "dash.no_activity": "Nenhum dado de atividade disponível ainda.",
    "dash.quick_access": "Acesso Rápido",
    "dash.no_favorites": "Você ainda não favoritou nenhuma ferramenta.",
    "dash.explore_tools": "Explorar Ferramentas",
    "dash.trending": "Ferramentas em Alta",
    "dash.view_all": "Ver Todas",
    "dash.no_trending": "Nenhuma ferramenta em alta disponível.",
    "dash.recent": "Gerações Recentes",
    "dash.view_history": "Ver Histórico",
    "dash.no_recent": "Nenhuma geração recente.",
    "dash.no_prompt": "Sem prompt disponível",
    // Mercado Pago
    "mp.pay": "Assinar com Mercado Pago",
    "mp.processing": "Redirecionando...",
    // Footer new links
  ...
  en: {
    ...
    "dash.welcome": "Welcome back. Here's what's happening with your workspace today.",
    "dash.token_balance": "Token Balance",
    "dash.tokens_used": "Tokens Used",
    "dash.total_generations": "Total Generations",
    "dash.favorites": "Favorites",
    "dash.billing_cycle": "This billing cycle",
    "dash.usage_overview": "Usage Overview",
    "dash.usage_desc": "Your AI generation activity over the last 30 days",
    "dash.no_activity": "No activity data available yet.",
    "dash.quick_access": "Quick Access",
    "dash.no_favorites": "You haven't favorited any tools yet.",
    "dash.explore_tools": "Explore Tools",
    "dash.trending": "Trending Tools",
    "dash.view_all": "View All",
    "dash.no_trending": "No trending tools available.",
    "dash.recent": "Recent Generations",
    "dash.view_history": "View History",
    "dash.no_recent": "No recent generations.",
    "dash.no_prompt": "No prompt available",
    // Mercado Pago
    "mp.pay": "Subscribe with Mercado Pago",
    "mp.processing": "Redirecting...",
    // Footer new links
