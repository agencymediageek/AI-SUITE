                ...
                >
                    ...
                    <div className="flex items-center gap-4 text-sm">
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-muted rounded-full">
                            ...
                            <span><strong>{displayCost}</strong> tokens por uso</span>
                        </div>
                        {user && (
                            <div className="text-muted-foreground">
                                Seu saldo: <strong>{user.tokens?.toLocaleString() || 0}</strong> tokens
                            </div>
                        )}
                    </div>
                </motion.div>
                    ...
                    >
                        <Card className="h-full">
                            <CardHeader>
                                ...
                                <CardDescription>Descreva o que você quer gerar</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                ...
                                {examplePrompts.length > 0 && (
                                    <div className="space-y-2">
                                        <p className="text-sm text-muted-foreground">Experimente estes exemplos:</p>
