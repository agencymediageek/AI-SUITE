...
const PT_DEFAULT: LanguageInfo = { code: "pt", name: "Português", direction: "ltr" };
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
    ...
    // Load PT translations on initial render (default locale)
    useEffect(() => {
        loadTranslations("pt");
    ...
    useEffect(() => {
        ...
        const saved = localStorage.getItem("ai-suite-locale") || "pt";
        if (saved && saved !== "en") {
