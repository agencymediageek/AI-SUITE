...
export default function LandingPage() {
    ...
    const features: Feature[] = [
        {
            title: t("Live Chat"),
            description: t("Intelligent live support agent for your queries."),
            icon: MessageSquare,
            url: "/support-agent",
        ...
        {
            title: t("AI Website Builder"),
            description: t("Generate full websites from a single prompt with modern designs."),
            icon: LayoutTemplate,
            url: "/website",
        ...
        {
            title: t("AI Chat Assistant"),
            description: t("Intelligent conversations powered by advanced language models."),
            icon: MessageSquare,
            url: "/chat",
        ...
        },
        {
            ...
            description: t("Write, debug, and refactor code in any programming language."),
            icon: Code,
            url: "/code",
        ...
        },
        {
            ...
            description: t("Create blog posts, articles, and marketing copy instantly."),
            icon: PenTool,
            url: "/writer",
            color: "from-pink-500 to-rose-500",
        },
        {
            title: t("Document Summarizer"),
            description: t("Turn lengthy documents into concise executive summaries."),
            icon: FileText,
            url: "/summary",
        ...
        },
        {
            ...
            description: t("Create stunning visuals from text descriptions."),
            icon: Image,
            url: "/ai-marketing/image-generator",
            color: "from-indigo-500 to-violet-500",
        },
        {
            title: t("SQL Architect"),
            description: t("Transform natural language into complex SQL queries."),
            icon: Database,
            url: "/sql",
            color: "from-slate-500 to-gray-600",
        },
        {
            title: t("Translation Hub"),
            description: t("Professional translations in 50+ languages."),
            icon: Languages,
            url: "/translator",
        ...
        {
            title: t("Quiz Master"),
            description: t("Generate educational assessments and quizzes."),
            icon: Brain,
            url: "/quiz",
        ...
        },
        {
            ...
            description: t("Create ATS-optimized resumes and cover letters."),
            icon: FileUser,
            url: "/resume",
            color: "from-yellow-500 to-orange-500",
        },
        {
            title: t("Social Suite"),
            description: t("Craft viral posts, captions, and hashtags."),
            icon: Share2,
            url: "/social",
        ...
        },
        {
            ...
            description: t("Draft professional emails and responses."),
            icon: Mail,
            url: "/email",
            color: "from-red-500 to-pink-500",
        },
        {
            title: t("AI Music Studio"),
            description: t("Generate professional tracks from text or lyrics with Suno V5."),
            icon: Music,
            url: "/music-generator",
            color: "from-purple-500 to-pink-500",
            isNew: true,
        ...
        {
            title: t("AI Marketing Suite"),
            description: t("Social media automation, SEO content, and ad copy generation."),
            icon: Megaphone,
            url: "/social",
            color: "from-blue-500 to-cyan-500",
            isNew: true,
    ...
    const aiMarketingFeatures = [
        {
            icon: Share2,
            title: t("Social Media Automation"),
            description: t("Auto-generate viral posts, captions, and hashtags for every platform. Schedule and optimize content at scale."),
            color: "from-blue-500 to-cyan-500",
        },
        {
            icon: Newspaper,
            title: t("SEO Content Engine"),
            description: t("Create SEO-optimized blog posts, landing pages, and meta descriptions that rank on Google."),
            color: "from-emerald-500 to-teal-500",
        },
        {
            icon: Mail,
            title: t("Email Campaigns"),
            description: t("Craft high-converting email sequences, newsletters, and drip campaigns powered by AI."),
            color: "from-pink-500 to-rose-500",
        },
        {
            icon: MousePointerClick,
            title: t("Ad Copy Generator"),
            description: t("Generate compelling ad copy for Google, Meta, LinkedIn, and TikTok in seconds."),
            color: "from-amber-500 to-orange-500",
        },
        {
            icon: Target,
            title: t("Brand Voice Analysis"),
            description: t("Train AI on your brand tone and style for consistent messaging across all channels."),
            color: "from-violet-500 to-purple-500",
        },
        {
            icon: BarChart3,
            title: t("Marketing Analytics"),
            description: t("AI-powered insights on campaign performance with actionable optimization suggestions."),
    ...
    const musicFeatures = [
        {
            icon: Music2,
            title: t("Text-to-Music"),
            description: t("Describe any mood, genre, or vibe and get professional-quality tracks generated instantly."),
            color: "from-purple-500 to-violet-600",
        },
        {
            icon: Mic2,
            title: t("Custom Lyrics Mode"),
            description: t("Write your own lyrics and let AI compose the perfect melody, harmony, and arrangement."),
            color: "from-pink-500 to-fuchsia-500",
        },
        {
            icon: Palette,
            title: t("Genre Mixing"),
            description: t("Blend multiple genres seamlessly — from lo-fi jazz to cinematic synthwave and beyond."),
            color: "from-cyan-500 to-blue-500",
        },
        {
            icon: Wand2,
            title: t("Audio Isolation"),
            description: t("Separate vocals, drums, bass, and instruments from any track with studio precision."),
            color: "from-emerald-500 to-green-500",
        },
        {
            icon: Radio,
            title: t("Multi-Model Engine"),
            description: t("Choose between Suno V5, V4.5, and V4.5 Plus for the perfect sound quality."),
            color: "from-amber-500 to-yellow-500",
        },
        {
            icon: Headphones,
            title: t("48kHz Stereo Export"),
            description: t("Download your tracks in high-quality 48kHz stereo — ready for streaming and production."),
            color: "from-rose-500 to-red-500",
        },
    ];

    const stats = [
        { value: TOOLS_COUNT_DISPLAY, label: t("AI Tools") },
        { value: "50K+", label: t("Active Users") },
        { value: "10M+", label: t("Generations") },
    ...
    const pricingPlans = [
        {
            ...
            price: "$0",
            period: t("forever"),
            description: t("Perfect for trying out AI Suite"),

            features: [
                t("1,000 tokens"),
                t("Access to 10 AI tools"),
                t("Standard response time"),
                t("Community support"),
            ],
            cta: "Get Started",
            popular: false,
        },
        {
            ...
            price: "$19",
            period: t("/month"),
            description: t("Best for professionals and creators"),
            features: [
                t("50,000 tokens/month"),
                t("Access to all") + " " + TOOLS_COUNT_DISPLAY + " " + t("AI tools"),
                t("Priority response time"),
                t("API access"),
                t("Priority support"),
                t("Custom templates"),
            ],
        ...
        },
        {
            ...
            price: "Custom",
            period: "",
            description: t("For teams and organizations"),
            features: [
                t("Unlimited tokens"),
                t("All Pro features"),
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Link href="/register" target="_blank" rel="noopener noreferrer">
                                <Button size="sm">{t("Get Started Free")}</Button>
                            </Link>
                        </div>
                    </nav>
                        ...
                        >
                            <nav className="container mx-auto px-4 py-6 space-y-4 flex flex-col">
                                ...
                                <Link href="/login" target="_blank" rel="noopener noreferrer" onClick={() => setIsMobileMenuOpen(false)}>
                                    <Button variant="outline" className="w-full">{t("Log in")}</Button>
                                </Link>
                                <Link href="/register" target="_blank" rel="noopener noreferrer" onClick={() => setIsMobileMenuOpen(false)}>
                                    <Button className="w-full">{t("Get Started Free")}</Button>
                                </Link>
                            </nav>
                        </motion.div>
                    )}
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-sm font-medium text-primary">
                            {t("New: AI Music Studio & Marketing Suite are live!")}
                        </span>
                    ...
                    >
                        {t("Acesse")} {TOOLS_COUNT_DISPLAY} {t("poderosas ferramentas de IA. Gere conteúdo, código, imagens, sites e muito mais com tecnologia de IA de ponta.")}
                    </motion.p>
            ...
            <section className="py-12 border-y border-border/50 bg-muted/30">
                <div className="container mx-auto px-4">
                    <p className="text-center text-sm text-muted-foreground mb-8">
                        {t("Trusted by 50,000+ professionals worldwide")}
                    </p>
            ...
            <section id="features" className="py-24">
                <div className="container mx-auto px-4">
                    <motion.div
                        ...
                        variants={fadeInUp}
                    >
                        <Badge className="mb-4">{t("Features")}</Badge>
                        <h2 className="text-4xl md:text-5xl font-bold mb-4">
                            {t("Everything You Need to Create")}
                        </h2>
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                            {t("Powerful AI tools designed to supercharge your productivity and creativity.")}
                        </p>
                    </motion.div>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                            {t("From social media to SEO, email campaigns to ad copy — automate and elevate your entire marketing stack with AI-powered tools.")}
                        </p>
                    </motion.div>
                        ...
                        >
                            <div className="relative rounded-2xl border bg-card/80 backdrop-blur-xl p-6 shadow-2xl overflow-hidden">
                                ...
                                <div className="flex items-center justify-between mb-6">
                                    <div>
                                        <h3 className="font-bold text-lg">{t("Marketing Dashboard")}</h3>
                                        <p className="text-xs text-muted-foreground">{t("Real-time campaign analytics")}</p>
                                    </div>
                                ...
                                <div className="grid grid-cols-3 gap-3 mb-6">
                                    {[
                                        { label: t("Engagement"), value: "84.2%", change: "+12.5%", color: "text-green-500" },
                                        { label: t("CTR"), value: "6.8%", change: "+3.2%", color: "text-blue-500" },
                                        { label: t("Conversions"), value: "2,847", change: "+18.7%", color: "text-violet-500" },
                                    ].map((stat, i) => (
                            ...
                            >
                                ...
                                <p className="text-[10px] text-muted-foreground">{t("ROI this month")}</p>
                            </motion.div>
                            ...
                            >
                                ...
                                <p className="text-[10px] text-muted-foreground">{t("New followers")}</p>
                            </motion.div>
                        </motion.div>
                    </div>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        <Badge className="mb-4 bg-gradient-to-r from-purple-500 to-pink-500 border-0 text-white">
                            <Music className="w-3 h-3 mr-1" /> {t("AI Music Studio")}
                        </Badge>
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-5">
                            {t("Create Professional")}{" "}
                            <span className="bg-gradient-to-r from-purple-500 via-pink-500 to-rose-500 bg-clip-text text-transparent">
                                {t("Music with AI")}
                            </span>
                        </h2>
                        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                            {t("From text descriptions to full productions — generate studio-quality tracks with Suno V5. Custom lyrics, genre mixing, and audio isolation included.")}
                        </p>
                    </motion.div>
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-xs text-muted-foreground uppercase tracking-wider mb-1">
                                            {summerVibesSong ? t("Featured Creation") : t("Now Generating")}
                                        </p>
            ...
            <section id="pricing" className="py-24 bg-muted/30">
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                            {t("Start free and scale as you grow. No hidden fees.")}
                        </p>
                    </motion.div>
                                    ...
                                    >
                                        ...
                                        <CardContent className="p-8">
                                            ...
                                            <div className="flex items-baseline gap-1 mb-2">
                                                ...
                                                <span className="text-muted-foreground">{t(displayPeriod) || displayPeriod}</span>
                                            </div>
                                            ...
                                            <Link href="/register" target="_blank" rel="noopener noreferrer">
                                                ...
                                                >
                                                    {t(plan.cta || (isEnterprise ? "Contact Sales" : "Get Started"))}
                                                </Button>
                                            </Link>
                                        </CardContent>
                                    </Card>
            ...
            <footer className="border-t border-border/40 bg-background pt-16 pb-8">
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-4 gap-12 mb-12">
                        <div className="col-span-1 md:col-span-2 space-y-4">
                            ...
                            <p className="text-muted-foreground max-w-sm">
                                {settings?.metadata?.siteDescription || t("The complete AI toolkit for modern creators and professionals. Built with cutting-edge technology.")}
                            </p>
                            <p className="text-sm text-muted-foreground">
                                {t("100+ AI Tools")}
                            </p>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                ...
                                <li><a href="#ai-marketing" className="hover:text-foreground transition-colors">{t("AI Marketing")}</a></li>
                                <li><a href="#music-generation" className="hover:text-foreground transition-colors">{t("Music Studio")}</a></li>
                                <li><a href="#pricing" className="hover:text-foreground transition-colors">{t("Pricing")}</a></li>
                                <li><a href="#" className="hover:text-foreground transition-colors">{t("Changelog")}</a></li>
                    ...
                    <div className="border-t border-border/40 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-sm text-muted-foreground">
                            © 2026 {settings?.metadata?.siteName || "MediaGeek A.I"}. {t("All rights reserved.")}
                        </p>
