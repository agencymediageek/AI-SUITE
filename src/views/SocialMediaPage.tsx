        ...
        <Card className="ai-card">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="contentType">{t("social.contentType")}</Label>
              ...
              <div>
                <Label htmlFor="tone">{t("social.tone")}</Label>
            ...
            <div>
              <Label htmlFor="description">{t("social.contentDescription")}</Label>
              <Textarea
                id="description"
                value={formData.description}
                onChange={(e) => handleInputChange("description", e.target.value)}
                placeholder={t("social.descPlaceholder")}
                rows={3}
              />
            </div>

            <div>
              <Label htmlFor="keywords">{t("social.keywords")}</Label>
              <Input
                id="keywords"
        ...
        <div className="space-y-4">
          ...
          <Tabs defaultValue="caption" className="w-full">
            <TabsList className="grid w-full grid-cols-3">
              <TabsTrigger value="caption">{t("social.caption")}</TabsTrigger>
              <TabsTrigger value="hashtags">{t("social.hashtags")}</TabsTrigger>
              <TabsTrigger value="ideas">{t("social.ideas")}</TabsTrigger>
            </TabsList>
              ...
              <Card className="ai-card">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle>{t("social.generatedCaption")}</CardTitle>
                    {results.caption && (
                      <Button
                        variant="outline"
                        size="sm"
            ...
            <TabsContent value="hashtags">
              <Card className="ai-card">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle>{t("social.suggestedHashtags")}</CardTitle>
