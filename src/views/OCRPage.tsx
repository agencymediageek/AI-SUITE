...
export default function OCRPage() {
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6">
      <div>
        <h1 className="text-xl lg:text-3xl font-bold ai-gradient-text">{t("ocr.title")}</h1>
          ...
          <CardContent className="space-y-4">
            ...
            {selectedImage && (
              <div className="space-y-2">
                <Label className="text-sm font-medium">{t("ocr.previewLabel")}</Label>
      ...
      <Card className="ai-card">
        <CardHeader>
          <CardTitle>{t("ocr.features")}</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4">
              <Image className="w-8 h-8 mx-auto mb-2 text-ai-primary" />
              <h3 className="font-semibold mb-1">{t("ocr.accuracy")}</h3>
            ...
            <div className="text-center p-4">
              ...
              <h3 className="font-semibold mb-1">{t("ocr.formats")}</h3>
            ...
            <div className="text-center p-4">
              ...
              <h3 className="font-semibold mb-1">{t("ocr.export")}</h3>
