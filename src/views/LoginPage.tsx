...
// features & formSchema moved inside component to access t()
    ...
    const features: Feature[] = [
        {
            icon: Zap,
            title: t("AI Tools"),
            description: t("Access the most comprehensive AI toolkit"),
        },
        {
            icon: Shield,
            title: t("Enterprise Security"),
            description: t("Your data is encrypted and protected"),
        },
        {
            icon: Users,
            title: t("Join 50,000+ Users"),
            description: t("Trusted by professionals worldwide"),
        },
    ];
        ...
        try {
            ...
            if (result.success) {
                if (result.requires2FA && result.tempToken) {
                    ...
                    toast({
                        title: t("Two-Factor Required"),
                        description: t("Please enter your authentication code."),
                    });
                } else {
                    toast({
                        title: t("Welcome back!"),
                        description: t("Successfully logged in."),
                    });
                    router.refresh();
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-lg text-white/80 max-w-md">
                                {t("Sign in to access your personalized AI tools and continue creating.")}
                            </p>
                        </div>
                ...
                {requires2FA ? (
                    ...
                    >
                        <div className="p-8 rounded-3xl border border-zinc-200 dark:border-white/5 bg-white/80 dark:bg-zinc-900/40 backdrop-blur-2xl shadow-2xl">
                            ...
                            <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-2">{t("Verify Your Email")}</h2>
                            <p className="text-zinc-600 dark:text-zinc-400 text-sm mb-6 leading-relaxed">
                                {t("You must verify your email address to log in. Please check your inbox for a verification link.")}
                            </p>
                    ...
                    >
                        ...
                        <div className="text-center mb-8">
                            <h2 className="text-3xl font-bold mb-2">{t("Sign in to your account")}</h2>
                            <p className="text-muted-foreground">
                                {t("Enter your credentials to access your workspace")}
                            </p>
                        </div>
                        ...
                        <div className="mt-6 flex justify-center">
                            <div className="inline-flex items-center px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-medium">
                                ...
                                {t("New users receive 300 free tokens")}
                            </div>
                        </div>
                    </motion.div>
                )}
