          ...
          <CardContent className="p-8">
            <AnimatePresence mode="wait">
              ...
              {step === "EMAIL" && (
                ...
                >
                  <div className="text-center">
                    <h2 className="text-2xl font-bold mb-2">{t("forgot.title")}</h2>
              ...
              {step === "OTP" && (
                ...
                >
                  <div className="text-center">
                    <h2 className="text-2xl font-bold mb-2">{t("forgot.checkEmail")}</h2>
                    <p className="text-muted-foreground text-sm">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="w-full flex flex-col items-center">
                            <FormLabel className="self-start">{t("forgot.verificationCode")}</FormLabel>
                            <FormControl>
                              <InputOTP
                                maxLength={6}
                                value={field.value}
              ...
              {step === "RESET" && (
                ...
                >
                  <div className="text-center">
                    <h2 className="text-2xl font-bold mb-2">{t("forgot.setNewPassword")}</h2>
                    <p className="text-muted-foreground text-sm">
                  ...
                  <Form {...resetForm}>
                    <form onSubmit={resetForm.handleSubmit(onResetSubmit)} className="space-y-5">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>{t("forgot.newPassword")}</FormLabel>
                            <FormControl>
                              <div className="relative">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>{t("forgot.confirmPassword")}</FormLabel>
                            <FormControl>
                              <div className="relative">
                                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                                <Input
              ...
              {step === "SUCCESS" && (
                ...
                >
                  ...
                  <h2 className="text-2xl font-bold">{t("forgot.resetSuccess")}</h2>
