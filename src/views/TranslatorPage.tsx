...
export default function TranslatorPage() {
  ...
  const handleTranslate = async () => {
    ...
    const sourceLanguage = languages.find(l => l.code === sourceLang)?.name || t("translator.autoDetect");
...
"${sourceText}"`;
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6">
      <div>
        <h1 className="text-xl lg:text-3xl font-bold ai-gradient-text">{t("translator.title")}</h1>
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
            <div className="flex-1 space-y-2">
              <label className="text-sm font-medium">{t("translator.from")}</label>
              <Select value={sourceLang} onValueChange={setSourceLang}>
                <SelectTrigger>
                  <SelectValue placeholder={t("translator.autoDetect")} />
                </SelectTrigger>
                <SelectContent>
                  {languages.map((lang) => (
            ...
            <div className="flex-1 space-y-2">
              <label className="text-sm font-medium">{t("translator.to")}</label>
              <Select value={targetLang} onValueChange={setTargetLang}>
                <SelectTrigger>
                  <SelectValue placeholder={t("translator.selectLang")} />
                </SelectTrigger>
                <SelectContent>
                  {languages.map((lang) => (
                    <SelectItem key={lang.code} value={lang.code}>
        ...
        <Card className="ai-card">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-sm font-medium">{t("translator.quickExamples")}</p>
      ...
      <Card className="ai-card">
        <CardHeader>
          <CardTitle>{t("translator.supportedLangs")}</CardTitle>
          <CardDescription>
