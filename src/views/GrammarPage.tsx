...
export default function GrammarPage() {
  ...
  const handleCheckGrammar = async () => {
    if (!originalText.trim()) {
      toast({
        title: "Error",
        description: t("grammar.emptyError"),
        variant: "destructive"
      });
      return;
    }
...
- [list of specific changes made]`;
  ...
  const handleCopyText = () => {
    if (correctedText) {
      ...
      toast({
        title: "Copied",
        description: t("grammar.copiedDesc"),
      });
    }
  };
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6">
      <div>
        <h1 className="text-xl lg:text-3xl font-bold ai-gradient-text">{t("grammar.title")}</h1>
        ...
        <Card className="ai-card">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-sm font-medium">{t("grammar.tryExamples")}</p>
      ...
      <Card className="ai-card">
        <CardHeader>
          <CardTitle>{t("grammar.features")}</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4">
              <CheckSquare className="w-8 h-8 mx-auto mb-2 text-ai-primary" />
              <h3 className="font-semibold mb-1">{t("grammar.correction")}</h3>
            ...
            <div className="text-center p-4">
              ...
              <h3 className="font-semibold mb-1">{t("grammar.styleEnhancement")}</h3>
            ...
            <div className="text-center p-4">
              ...
              <h3 className="font-semibold mb-1">{t("grammar.voicePreservation")}</h3>
