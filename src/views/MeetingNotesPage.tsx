        ...
        <div className="space-y-4">
          <Tabs defaultValue="summary" className="w-full">
            <TabsList className="grid w-full grid-cols-4">
              ...
              <TabsTrigger value="actions">{t("meeting.actions")}</TabsTrigger>
              <TabsTrigger value="decisions">{t("meeting.decisions")}</TabsTrigger>
              <TabsTrigger value="next">{t("meeting.nextSteps")}</TabsTrigger>
            </TabsList>
