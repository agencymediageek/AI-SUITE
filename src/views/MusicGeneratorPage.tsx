                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        <Label htmlFor="style" className="text-sm font-semibold">{t("music.styleGenre")}</Label>
                                        <Input
                                            id="style"
                                ...
                                <div className="pt-4 border-t border-muted space-y-4">
                                    <div className="flex items-center justify-between">
                                        <div className="space-y-0.5">
                                            ...
                                            <p className="text-xs text-muted-foreground">{t("music.instrumental")}</p>
                                        </div>
                                        <Switch 
                                    ...
                                    <div className="space-y-2">
                                        <Label className="text-sm font-semibold">{t("music.aiModel")}</Label>
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            {status === "idle" && (
                                ...
                                >
                                    ...
                                    <h3 className="text-xl font-semibold mb-2">{t("music.readyToCompose")}</h3>
                        ...
                        <Card className="bg-gradient-to-br from-blue-600 to-cyan-500 text-white border-none shadow-lg overflow-hidden">
                            <CardContent className="p-6 relative">
                                ...
                                <div className="relative z-10 flex items-center gap-6">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold">{t("music.isolationPro")}</h3>
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="text-xl font-bold outfit">{t("music.history")}</h2>
                                    <p className="text-xs text-muted-foreground">{t("music.historyDesc")}</p>
                                </div>
                            </div>
