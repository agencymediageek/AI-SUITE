            ...
            <div>
              ...
              <Select value={formData.language} onValueChange={(value) => handleInputChange("language", value)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Spanish">{t("lang.spanish")}</SelectItem>
                  <SelectItem value="French">{t("lang.french")}</SelectItem>
                  <SelectItem value="German">{t("lang.german")}</SelectItem>
                  <SelectItem value="Italian">{t("lang.italian")}</SelectItem>
                  <SelectItem value="Portuguese">{t("lang.portuguese")}</SelectItem>
                </SelectContent>
              </Select>
            </div>

            <div>
              <Label htmlFor="text">{t("sentiment.textToAnalyze")}</Label>
              <Textarea
                id="text"
                value={formData.text}
        ...
        <div className="space-y-4">
          {results && (
            <>
              ...
              <Card className="ai-card">
                <CardHeader>
                  <CardTitle>{t("sentiment.breakdown")}</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm font-medium text-yellow-600">{t("sentiment.neutral")}</span>
          ...
          <Tabs defaultValue="emotions" className="w-full">
            <TabsList className="grid w-full grid-cols-3">
              <TabsTrigger value="emotions">{t("sentiment.emotions")}</TabsTrigger>
              <TabsTrigger value="keywords">{t("sentiment.keywords")}</TabsTrigger>
              <TabsTrigger value="summary">{t("sentiment.summary")}</TabsTrigger>
            </TabsList>

            <TabsContent value="emotions">
              <Card className="ai-card">
                <CardHeader>
                  <CardTitle>{t("sentiment.detectedEmotions")}</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="keywords">
              <Card className="ai-card">
                <CardHeader>
                  <CardTitle>{t("sentiment.keyTerms")}</CardTitle>
                </CardHeader>
                <CardContent>
          ...
          {!results && !isStreaming && (
            <Card className="ai-card">
              <CardContent className="text-center py-12">
                ...
                <p className="text-lg mb-2">{t("sentiment.readyTitle")}</p>
          ...
          {isStreaming && !results && (
            <Card className="ai-card">
              <CardHeader>
                <CardTitle>{t("sentiment.analyzing")}</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="bg-muted/30 p-4 rounded-lg">
