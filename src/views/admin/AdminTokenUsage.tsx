    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
                ...
                <p className="text-muted-foreground animate-pulse font-medium tracking-wide">{t("admin.tokenUsage.crunching")}</p>
            </div>
        );
    }
        ...
        <div className="p-6 md:p-10 max-w-[1400px] mx-auto space-y-10">
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-2 bg-card border shadow-sm px-4 py-2 rounded-full">
                    ...
                    <span className="text-sm font-semibold tracking-tight">{t("admin.tokenUsage.liveUpdating")}</span>
                </div>
            </motion.div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-1">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <CardTitle className="text-xl font-bold tracking-tight">{t("admin.tokenUsage.consumptionTrend")}</CardTitle>
                                    </div>
                                ...
                                <ResponsiveContainer width="100%" height="100%">
                                    <AreaChart data={stats.dailyUsage} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
                                        ...
                                        <Tooltip 
                                            ...
                                            formatter={(value: number) => [new Intl.NumberFormat().format(value), t("admin.tokenUsage.tokens")]}
                                        />
                                        <Area 
                                            type="monotone" 
                                            dataKey="tokens" 
                    ...
                    <Card className="h-full border shadow-sm bg-card/60 backdrop-blur-xl">
                        <CardHeader className="px-8 pt-8 pb-4 border-b border-border/50">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <CardTitle className="text-xl font-bold tracking-tight">{t("admin.tokenUsage.topTools")}</CardTitle>
                                ...
                                >
                                    <div className="flex justify-between items-end">
                                        ...
                                        <div className="flex items-baseline gap-1">
                                            ...
                                            <span className="text-[10px] uppercase font-bold tracking-wider text-muted-foreground">{t("admin.tokenUsage.tokens")}</span>
                                        </div>
                                    </div>
                    ...
                    <Card className="h-full border shadow-sm bg-card/60 backdrop-blur-xl relative overflow-hidden">
                        <CardHeader className="px-8 pt-8 pb-4 border-b border-border/50">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <CardTitle className="text-xl font-bold tracking-tight">{t("admin.tokenUsage.powerUsers")}</CardTitle>
