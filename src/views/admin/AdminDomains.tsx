    ...
    const fetchDomains = async () => {
        try {
            ...
            toast({
                ...
                description: error?.message || t("admin.domains.failedLoad"),
                variant: "destructive",
            });
        } finally {
            setLoading(false);
    ...
    const handleDeleteDomain = async (domain: Domain) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                toast({ title: t("common.success"), description: t("admin.domains.deleted") });
            } else {
                throw new Error(t("admin.domains.failedDelete"));
            }
        } catch (error: any) {
            console.error("API delete failed", error);
            toast({ title: t("common.error"), description: error?.message || t("admin.domains.failedDelete"), variant: "destructive" });
        }
    };
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">{t("admin.domains.title")}</h1>
            ...
            <Card>
                <CardContent className="p-4">
                    <div className="relative flex-1">
                        ...
                        <Input
                            placeholder={t("admin.domains.searchPlaceholder")}
                            value={searchQuery}
            ...
            <Card>
                <CardContent className="p-0">
                    <Table>
                        <TableHeader>
                            <TableRow>
                                <TableHead>{t("admin.domains.subdomain")}</TableHead>
                                <TableHead>{t("common.name")}</TableHead>
                                <TableHead>{t("admin.domains.userEmail")}</TableHead>
                    ...
                    {filteredDomains.length === 0 && (
                        <div className="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <p className="text-lg font-medium">{t("admin.domains.noDomains")}</p>
