    ...
    useEffect(() => {
        const fetchStats = async () => {
            ...
            try {
                ...
                if (!res.ok) throw new Error(t("Failed to fetch stats"));
    ...
    const stats = [
        {
            ...
            description: t("Registered accounts"),
            icon: Users,
        ...
        {
            title: t("Websites Created"),
            value: data?.totalWebsites?.toLocaleString() || "3,421",
            description: t("AI-generated sites"),
            icon: LayoutTemplate,
        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col lg:flex-row gap-6 items-stretch">
                ...
                <Card className="flex-1 w-full flex flex-col">
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            <div>
                                <CardTitle>{t("Revenue & Growth")}</CardTitle>
                                <CardDescription>
                                    {t("Monthly revenue and user acquisition")}
                                </CardDescription>
                            </div>
                ...
                <Card className="w-full lg:w-[32%] lg:min-w-[300px] flex flex-col max-h-[420px]">
                    <CardHeader className="shrink-0">
                        ...
                        <CardDescription>{t("Distribution by AI tool")}</CardDescription>
                    </CardHeader>
                    ...
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <CardDescription>{t("Latest user actions")}</CardDescription>
                            </div>
                    ...
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <CardDescription>{t("Service health")}</CardDescription>
                            </div>
                            <Badge variant="soft-success">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>{t("Common administrative tasks")}</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                            { label: t("Manage Users"), icon: UserPlus, href: "/admin/users", color: "bg-blue-500" },
                            { label: t("Manage Plans"), icon: CreditCard, href: "/admin/plans", color: "bg-green-500" },
                            { label: t("View Analytics"), icon: BarChart3, href: "/admin/token-usage", color: "bg-purple-500" },
                            { label: t("System Settings"), icon: Settings, href: "/admin/settings", color: "bg-orange-500" },
                        ].map((action, index) => (
