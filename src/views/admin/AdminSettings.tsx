...
export default function AdminSettings() {
    ...
    const fetchSettings = async () => {
        try {
            ...
            toast({ title: t("Error"), description: error?.message || t("Failed to load settings"), variant: "destructive" });
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleSave = async () => {
        ...
        if (window.location.href.includes('mounikai')) {
            toast({ title: t("Demo mode"), description: t("we disable this feature in demo mode") })
            return
        }
        ...
        try {
            ...
            toast({
                ...
                description: t("Your changes have been applied successfully."),
            });
        } catch (error: any) {
            toast({
                title: t("Error"),
                description: error?.message || t("Failed to save settings. Please try again."),
                variant: "destructive",
            });
        } finally {
            setSaving(false);
    ...
    const handleTestEmail = async () => {
        ...
        try {
            ...
            if (res.ok) {
                toast({
                    title: t("Success"),
                    description: t("Test email sent successfully!"),
                });
            } else {
                toast({
                    title: t("Error"),
                    description: data.error || t("Failed to send test email."),
                    variant: "destructive",
                });
            }
        } catch (error: any) {
    ...
    const handleTestPaypal = async () => {
        ...
        try {
            ...
            if (res.ok) {
                toast({
                    title: t("Success"),
                    description: t("PayPal connection verified successfully!"),
                });
            } else {
                toast({
                    title: t("Connection Failed"),
                    description: data.error || t("Failed to connect to PayPal."),
                    variant: "destructive",
                });
            }
        } catch (error: any) {
    ...
    const handleTestFlutterwave = async () => {
        ...
        try {
            ...
            if (res.ok) {
                toast({
                    title: t("Success"),
                    description: t("Flutterwave connection verified successfully!"),
                });
            } else {
                toast({
                    title: t("Connection Failed"),
                    description: data.error || t("Failed to connect to Flutterwave."),
                    variant: "destructive",
                });
            }
        } catch (error: any) {
    ...
    const handleTestRazorpay = async () => {
        ...
        try {
            ...
            if (res.ok) {
                toast({
                    title: t("Success"),
                    description: t("Razorpay connection verified successfully!"),
                });
            } else {
                toast({
                    title: t("Connection Failed"),
                    description: data.error || t("Failed to connect to Razorpay."),
                    variant: "destructive",
                });
            }
        } catch (error: any) {
    ...
    const handleTestPaystack = async () => {
        ...
        try {
            ...
            if (res.ok) {
                toast({
                    title: t("Success"),
                    description: t("Paystack connection verified successfully!"),
                });
            } else {
                toast({
                    title: t("Connection Failed"),
                    description: data.error || t("Failed to connect to Paystack."),
                    variant: "destructive",
                });
            }
        } catch (error: any) {
